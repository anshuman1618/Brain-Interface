...
export default tseslint.config(
  {
    ignores: [
      ...
      "scripts/ci/**",
      // The native shells. `android/` and `ios/` are generated by `cap add`
      // and rewritten by Capacitor on upgrade — and both contain a COPY of the
      // built SPA (gitignored, see .prettierignore), which is minified output
      // rather than source and lints as thousands of errors.
      "artifacts/mobile-app/android/**",
      "artifacts/mobile-app/ios/**",
    ],
  },
