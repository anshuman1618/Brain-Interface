        ...
        <DialogContent className="max-w-4xl rounded-none border-border bg-background p-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border bg-background">
            ...
            <div className="p-8 flex flex-col hover:bg-muted/10 transition-colors">
              <h3 className="font-mono uppercase tracking-wider font-bold text-foreground mb-2">
                Starter
              </h3>
              <div className="text-3xl font-mono mb-4 text-foreground">
              ...
              <ul className="text-sm font-mono text-muted-foreground space-y-3 mb-8 flex-1">
                <li className="flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-foreground">
                  5 Active Cases
                </li>
                <li className="flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-foreground">
                  2 Users
            ...
            <div className="p-8 flex flex-col bg-slate-800 text-white relative">
              ...
              <h3 className="font-mono uppercase tracking-wider font-bold text-gray-200 mb-2">
                Pro
              </h3>
              <div className="text-3xl font-mono mb-4 text-white">
                ₹2,499<span className="text-sm text-gray-400">/mo</span>
              </div>
              <ul className="text-sm font-mono text-gray-300 space-y-3 mb-8 flex-1">
                <li className="flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-white">
                  Unlimited Cases
                </li>
                <li className="flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-white">
                  10 Users
            ...
            <div className="p-8 flex flex-col hover:bg-muted/10 transition-colors">
              ...
              <div className="text-3xl font-mono mb-4 text-foreground">
                ₹5,999<span className="text-sm text-muted-foreground">/mo</span>
              </div>
              <ul className="text-sm font-mono text-muted-foreground space-y-3 mb-8 flex-1">
                <li className="flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:bg-foreground">
                  Unlimited Cases
