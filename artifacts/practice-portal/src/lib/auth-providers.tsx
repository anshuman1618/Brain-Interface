...
const GoogleMark = (
  <svg viewBox="0 0 24 24" className="h-5 w-5" aria-hidden="true">
    ...
    <path
      fill="#34A853"
      d="M12 24c3.11 0 5.72-1.03 7.62-2.8l-3.72-2.89c-1.03.69-2.35 1.1-3.9 1.1-3 0-5.55-2.03-6.46-4.76H1.7v2.98A11.5 11.5 0 0 0 12 24Z"
    />
    <path
      fill="#FBBC05"
      d="M5.54 14.65a6.9 6.9 0 0 1 0-4.42V7.25H1.7a11.5 11.5 0 0 0 0 10.38l3.84-2.98Z"
    />
    <path
      fill="#EA4335"
      d="M12 4.75c1.69 0 3.2.58 4.4 1.72l3.3-3.3C17.72 1.2 15.11 0 12 0 7.44 0 3.5 2.62 1.7 6.44l3.84 2.98C6.45 6.7 9 4.75 12 4.75Z"
    />
  </svg>
);
