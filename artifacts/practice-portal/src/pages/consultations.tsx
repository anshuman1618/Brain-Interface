...
export default function ConsultationsPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      {/* `flex-wrap`: at 320px the heading and a 202px action button cannot
          share a row, and without it the button simply hung off the page. */}
          ...
          columns={[
            {
              ...
              header: "Subject",
              card: "title",
              className: "font-mono uppercase tracking-wider text-xs font-medium",
              cell: (c) => c.title,
            },
            {
              key: "date",
              header: "Date",
              card: "subtitle",
              /* `whitespace-nowrap` kept for the TABLE only. In a card the
                 value has the full width of the row, and refusing to wrap is
                 what pushed this page sideways on a phone. */
              className: "font-mono uppercase tracking-wider text-xs",
              tableClassName: "whitespace-nowrap",
              cell: (c) => (c.scheduledAt ? formatDateTime(c.scheduledAt) : "N/A"),
            },
            {
              key: "category",
              header: "Category",
              ...
              cell: (c) => (
                <span
                  className={`px-2 py-1 text-3xs uppercase font-mono tracking-wider rounded-lg ${getCategoryBadgeClass(c.category as string)}`}
                >
            ...
            },
            {
              ...
              header: "Action",
              card: "action",
              className: "font-mono uppercase tracking-wider text-xs text-right",
              cell: (c) => (
                <>
                  {c.status === "scheduled" && (
                    <Button
