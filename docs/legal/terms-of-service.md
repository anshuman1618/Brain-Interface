...
LEX Practice is software for managing a legal practice: matters, tasks, a cause
list, documents, client communication and reporting. It is a tool for
practitioners. **It is not a law firm, it does not provide legal advice, and it
does not exercise professional judgement on your behalf.**

Two things follow from that, and they matter:

- **Conflict screening is an aid, not a clearance.** The Service compares the
  parties you enter against records already in your chamber and reports possible
  matches. It cannot know about matters outside the system, it will miss
  conflicts recorded under different names, and it will raise matches that are
  not conflicts. The professional decision remains entirely yours.
- **Deadline reminders are a convenience, not a diary system.** You remain
  responsible for every limitation period, filing date and listing.

## 3. Accounts and access

Access is invite-only. A chamber is created by its founder; everyone else is
admitted by an administrator of that chamber, at a role that administrator
chooses.

- Sign-in is passwordless, via a federated identity provider or a one-time code.
  Keep your email account secure — whoever controls it controls your access.
- You are responsible for who you admit and at what role, and for removing
  people who leave.
- Do not share accounts. Roles and the audit trail are per person, and a shared
  login destroys both.

## 4. Your data stays yours

**You own everything you put into the Service** — matters, documents, client
details, notes. We claim no ownership of it and no right to use it beyond
operating the Service for you.

We hold that data as your processor. Our handling of personal data within it is
governed by the [Privacy Policy](/legal/privacy) and, where it applies, the
[Data Processing Agreement](/legal/dpa).

**Confidentiality and privilege.** We understand that material in the Service is
likely to be confidential and may be privileged. We do not access chamber
content except where strictly necessary to operate or repair the Service, or
where compelled by law. We do not use it to train models, market to your
clients, or build products.
...
We may suspend access immediately where continuing would expose other customers
to serious risk. We will tell you why, and restore access once it is resolved.
...
Plans carry limits on open matters and on seats. These are enforced by the
Service, not merely advertised. Reaching a limit prevents new matters or new
...
- **Neither party is liable for indirect or consequential loss** — including
  loss of profit, business, goodwill or anticipated savings.
- **Our total liability** in any twelve-month period is capped at **the fees you
  paid us in the twelve months before the claim arose**.
- **We are not liable for professional loss arising from your practice** — a
...
You will indemnify us against claims arising from your unlawful use of the
Service or your breach of §5. We will indemnify you against claims that the
Service itself infringes a third party's intellectual property in India.
