...
| #   | Item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Status |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 0.1 | **The database EXPIRED on 9 September 2026 and the platform is down.** Render `free` plan (`dpg-d9t1dd2jobas738ac3g0-a`, Singapore), now `status: suspended`, `suspenders: [billing]`. The service cannot boot: `migrate-on-boot.mjs` fails with `getaddrinfo ENOTFOUND dpg-d9t1dd2jobas738ac3g0-a` and refuses to start the server, which is the designed behaviour. Suspended is not deleted, so upgrading the instance to a paid plan should revive it with the data — verify in the dashboard before assuming, and do it before Render reclaims it. | Owner  |
